...
datQuery <- TCGAquery(tumor = cancer, platform = PlatformCancer, level = "3")  lsSample <- TCGAquery_samplesfilter(query = datQuery)
...
TCGAdownload(data = datQuery, path = pathCancer, 
             type = dataType, samples = c(dataSmTP,dataSmTN))
